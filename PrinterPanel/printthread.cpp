...
unsigned int PrintThread::getTotalLay()
{
    return gcode->getTotalLayer();
}
unsigned int PrintThread::getTime()
{
    return gcode->getTotalTime();
}
unsigned int PrintThread::getTotalGmd()
{
    return gcode->getTotalGcmd();
}
